...
func interact(carried_item):
	...
	if selection == 1: new_item.set_item(&"raw_pork", 1)
	if selection == 2: new_item.set_item(&"raw_liver", 1)
	if selection == 3: new_item.set_item(&"miswa", 1)
	if selection == 4: new_item.set_item(&"bihon", 1)
	if selection == 5: new_item.set_item(&"sotanghon", 1)
	if selection == 6: new_item.set_item(&"miki", 1)
...
func _input(event: InputEvent) -> void:
	if hotbar_active == true:
		...
		elif selection == 7: selection = 1
			
		if selection == 1: hotbar_select_anim.play("1"); drink_name.text = "Raw Pork"
		elif selection == 2: hotbar_select_anim.play("2"); drink_name.text = "Raw Liver"
		elif selection == 3: hotbar_select_anim.play("3"); drink_name.text = "Miswa"
		elif selection == 4: hotbar_select_anim.play("4"); drink_name.text = "Bihon"
		elif selection == 5: hotbar_select_anim.play("5"); drink_name.text = "Sotanghon"
		elif selection == 6: hotbar_select_anim.play("6"); drink_name.text = "Miki"
